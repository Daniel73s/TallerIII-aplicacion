...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path:'productos/:codvet',
        loadChildren:()=>import('../productos/productos.module').then(m=>m.ProductosPageModule)
      },
      {
        path:'misproductos/:codvet',
        loadChildren:()=>import('../misproductos/misproductos.module').then(m=>m.MisproductosPageModule)
      },
      {
        path:'modproductos/:codproducto',
        loadChildren:()=>import('../modproductos/modproductos.module').then(m=>m.ModproductosPageModule)
      },
      {
        path:'addproductos/:codvet',
        loadChildren:()=>import('../addproductos/addproductos.module').then(m=>m.AddproductosPageModule)
      },
      {
        path: '',
